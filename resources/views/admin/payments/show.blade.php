                                    ...
                                    <div class="media-body">
                                        ...
                                        <div>
                                            ...
                                            @if(Storage::disk('local')->exists($supporting_document->path))
                                                ...
                                                <a href="{{route('admin.payments.view_file')}}?file={{$supporting_document->id}}" target="_blank" class="btn btn-xs btn-primary float-right" style="padding-top: 3px; padding-bottom: 3px; color: white; font-size: x-small">View</a>
                                            @else
